...
const RegisterSensor = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-inherit flex flex-col items-center justify-center min-h-[90vh] pb-20 md:max-w-[60rem]">
        ...
        {showMap && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 md:max-w-[60rem] md:max-h-[60rem] left-0.5">
            <div className="bg-white rounded-lg shadow-lg p-4 w-[90%] h-[70%] relative md:left-80 md:bottom-24">
              <button
